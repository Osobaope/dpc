...
plt.step(np.arange(len(y_Pred)), np.concatenate(([y_Pred[0]], y_Pred)), where='post')
plt.step(np.arange(len(uPred[1])), np.concatenate((uPred[1], [uPred[1][-1]])), where='post')
plt.step(np.arange(len(uPred[0])), np.concatenate((uPred[0], [uPred[0][-1]])), where='post')
plt.show()